...
public class SmallNumberTheoreticTransformTest {
    ...
    @Test
    public void testTransformRadix2VsNaive() {
    ...
    @Test
    public void testTransformRadix2RoundtripRandomly() {
    ...
    @Test
    public void testIsPrimitiveRootPrimeGenerator() {
    ...
    @Test
    public void testUniquePrimeFactors() {
        final Object[][] CASES = {
                {1, Arrays.asList()},
                {2, Arrays.asList(2)},
                {3, Arrays.asList(3)},
